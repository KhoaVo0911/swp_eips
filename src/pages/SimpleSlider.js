          ...
          {eventListImg &&
            eventListImg.map((item, index) => {
              return (
                <div
                  key={index}
                  className="relative pt-16  flex content-center items-center justify-centers "
                >
          ...
          {eventListImg &&
            eventListImg.map((item, index) => {
              return (
                <div
                  key={index}
                  className="relative pt-16  flex content-center w-full items-center justify-centers "
                >
                  <div className=" bg-cover bg-center absolute top-0 w-full h-full" />
                  <div className="container max-w-8xl relative mx-auto">
                    <img src={item.img} />
