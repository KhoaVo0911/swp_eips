...
//                         </td>
//                         <td scope="row">
//                           <input className="form-control" style={{ marginRight: '10px' }} type="text" name="profile-name" id="profile-name" />
//                         </td>
//                       </tr>
//                     </tbody>
//                   </table>
...
//                             <img src="images/profile/senior-man-white-sweater-eyeglasses.jpg" alt="" />
//                           </a>
            ...
            <table className="account-table table" style={{textAlign: 'center'}}>
              ...
              <tbody>
                <tr style={{textAlign: 'center'}}>
                  ...
                  <td scope="row">
                    <input className="form-control" style={{marginRight: 10}} type="text" name="profile-name" id="profile-name" />
                  </td>
                </tr>
              </tbody></table>
            <div className="col-2">
