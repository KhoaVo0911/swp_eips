...
import { EventAction, PostEventAsyncApi, PutEventAsyncApi, getEventAsyncApi } from '../services/event/eventSlice';
          ...
          <main className="bg-gray-200 ms-sm-auto py-4 px-md-4 border-start">
            <div className="row my-4">
              ...
              <div className="col-lg-6 col-6">
                ...
                <div>
                  <button onClick={handleClickOpen} className="nav-link form-control mb-3" style={{ textAlign: 'center' }} >
                    Create Event
                  </button>
                </div>
              </div>
          ...
          <DialogContent dividers >
            ...
            <div className='max-w-5xl my-2 mx-auto'>
              ...
              <TextField id="outlined-basic" error={formik.touched.area && formik.errors.area ? true : undefined}
                className='w-full' value={formik.values.area} name="area" onChange={formik.handleChange} onBlur={formik.handleBlur} label="Area" variant="outlined" />
